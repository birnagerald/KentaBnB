...
class Ad
{
    ...
    /**
     * Get the comment of an author in relation to an ad
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Gives an array with impossible booking dates for this ad
     *
     * @return array An Datetime array 
     */
    public function getNotAvailableDays(){
        $notAvailableDays = [];

        foreach($this->bookings as $booking) {
            // calc days between startDate and endDate
