...
class Booking
{
    ...
    public function isBookableDates(){
        // Must know impossible dates for the ad
        $notAvailableDays = $this->ad->getNotAvailableDays();

        // Compare choosing dates with impossible dates
        ...
        // array of string of bookingDays
